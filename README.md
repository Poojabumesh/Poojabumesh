# Hi, I'm Pooja Baralu Umesh

**MS in Data Science** | ML Engineer | USF ‘25  

## About Myself:
MS in Data Science with hands-on experience building and deploying end-to-end machine learning systems in production. Skilled in vector embeddings, LLMs, statistical modeling, and cloud technologies (AWS, Spark, Airflow). Delivered scalable, real-time AI solutions, including a production grade product agent. Actively seeking Machine Learning Engineer roles to drive impact through intelligent, deployable ML.
SKILLS
